...
frames[i] = -1; // Initialize frames to -1 (empty) usageHistory[i] = 0; // Initialize usage history
}
...
// Update the usage history by incrementing other pages for (int k = 0; k < MAX_FRAMES; k++) {
